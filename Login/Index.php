...
$query = $DBcon->query("SELECT * FROM web WHERE username=".$_SESSION['userSession']);
        ...
        <div class="container">
            ...
            <div class="col-xs-12">
                <div class="text-center">
                    <img src="profile\<?php echo $userRow['username']; ?>\<?php echo $userRow['pic_profile']; ?>" class="img-circle img-thumbnail" alt="Profile">
                </div>
            </div>
            <div class="col-xs-12">
                <div class="text-center">
                    <h2 class="con-title">Hello Anonymous</h2>
                </div>
            </div>
        </div>
    </section><!-- services -->
